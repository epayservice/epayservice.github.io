module.exports = {
  ...
  fees: {
    ...
    crypto: {
      title: 'Криптовалюта',
      descr: 'В настоящее время мы предоставляем только услуги по обмену криптовалюты. Это означает, что как только вы внесете криптовалюту на адрес депозита, мы обменяем вашу криптовалюту на USD и зачислим USD на ваш кошелек ePayService.'
    }
  },
