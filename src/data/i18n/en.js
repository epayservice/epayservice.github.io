module.exports = {
  ...
  services: {
    ...
    payrollSolutions: 'Payroll Solutions',
    virtualCards: 'Virtual Cards',
    localPayments: 'Local payments',
    sendMoneyToCard: 'Send money to card',
  ...
  footer: {
    ...
    followUs: 'Follow Us',
    twitter: 'Twitter',
    copyRight: '© Copyright ePayService 2007–<span></span>, <br>All rights reserved.',
  ...
  fees: {
    moneyTransfersUS: {
      ...
      linkText: 'More about ACH & DirectDeposit',
      direction: 'Direction',
      fee: 'Fee',
  ...
  important: 'Important!',
  cardValidPeriod: 'Card will be valid for 3 years',
  ...
  appDownload: {
    ...
    downloadText: 'Get it powered with Online.ePayServices payment system',
